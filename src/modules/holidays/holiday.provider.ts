...
export function provideHolidayResources(deps: SharedDependencies): Extract<ModuleResourcesProvider, { name: "holiday" }> {
  const holidayHttpClient = new AxiosHttpClient(deps.config.holidayApiUrl, "", "");
